...
if (isset($_POST["submit"])) {
    if (
        ...
        $sql = 'INSERT INTO `tabledb`(`product`, `price`, `description`, `category`) VALUES (:val1,:val2,:val3,:val4)';
...
<form class="form-valide" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                <input type="number" class="form-control" name="price" placeholder="price" value="<?php if (
                                                                                                        isset($price)
                                                                                                    ) {
                                                                                                        echo $price;
                                                                                                    } else {
