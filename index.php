...
<html lang="en">
  ...
  <body>
    <a href="insert.php"><button type="button" class="btn btn-primary col-md-12 text-center">Add New Item</button></a>
  ...
  <tbody>
    ...
    $stmt2 = $pdo->query(
        "SELECT `id`, `product`, `price`, `description`, `category` FROM `tabledb` LIMIT $start, $per_page;"
    );
